...
(function (Z, Q, r) {
    ...
    function F(b) {
        return function () {
            var a = arguments[0], c,
                a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.7/" + (b ? b + "/" : "") + a;
    ...
    function fa(b, a) {
        ...
        } else (a = b) && (K(b) ? a = fa(b, []) : Ja(b) ? a = new Date(b.getTime()) : $a(b) ? a = RegExp(b.source) : X(b) && (a = fa(b, {})));
        return a
    }
    ...
    function Rc(b, a) {
        var c = a;
        "string" === typeof b && "$" === b.charAt(0) ? c = r : za(a) ? c = "$WINDOW" :
    ...
    function Wb(b) {
        ...
        q((b || "").split("&"), function (b) {
            b && (c = b.split("="), d = Vb(c[0]), B(d) && (b = B(c[1]) ? Vb(c[1]) : !0, a[d] ? K(a[d]) ? a[d].push(b) : a[d] = [a[d], b] : a[d] = b))
        });
        return a
    }
    ...
    function wb(b, a, c, d) {
        function e(b) {
            ...
            if (!d || null != b) for (; e.length;) for (k = e.shift(),
                                                            l = 0, n = k.length; l < n; l++) for (p = A(k[l]), m ? p.triggerHandler("$destroy") : m = !m, s = 0, p = (C = p.children()).length; s < p; s++) e.push(Ba(C[s]));
    ...
    function Ca(b) {
        $b(b);
        var a = 0;
        for (b = b.childNodes || []; a < b.length; a++) Ca(b[a])
    }
    ...
    function ac(b, a, c, d) {
        ...
        la(b, "handle") && (z(a) ? q(e, function (a, c) {
            ...
            z(c) ? (Ab(b, a, e[a]), delete e[a]) : Ka(e[a] || [], c)
        }))
    }

    function $b(b, a) {
        var c = b[db], d = Qa[c];
        d && (a ? delete Qa[c].data[a] : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), ac(b)), delete Qa[c], b[db] = r))
    }

    function la(b, a, c) {
        var d =
            b[db], d = Qa[d || -1];
        if (B(c)) d || (b[db] = d = ++Xc, d = Qa[d] = {}), d[a] = c; else return d && d[a]
    }
    ...
    function yb(b, a) {
        if (a) {
            a = a.nodeName || !B(a.length) || za(a) ? [a] : a;
    ...
    function dc(b) {
        for (var a = 0, c = b.childNodes; a < c.length; a++) Ca(c[a]);
        ...
        function e(a) {
            ...
            q(a, function (a) {
                if (!k.get(a)) {
                    k.put(a, !0);
                    try {
                        if (D(a)) for (c = Ta(a), b = b.concat(e(c.requires)).concat(c._runBlocks), d = c._invokeQueue, g = 0, h = d.length; g < h; g++) {
                            var f = d[g], m = n.get(f[0]);
                            m[f[1]].apply(m, f[2])
                        } else L(a) ? b.push(n.invoke(a)) : K(a) ? b.push(n.invoke(a)) : Oa(a, "module")
                    } catch (l) {
                        throw K(a) && (a = a[a.length - 1]), l.message && (l.stack && -1 == l.stack.indexOf(l.message)) && (l = l.message + "\n" + l.stack),
                            Sa("modulerr", a, l.stack || l.message || l);
                    }
                }
            });
            return b
            ...
            "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, l, n, p, s, C, y, E, u, R, H) {
                ...
                function N(a, b, c, d, e, g) {
                    function f(a, c, d, e) {
                        ...
                        I = n = 0;
                        for (p = k.length; n < p; I++) m = C[I], c = k[n++], g = k[n++], l = A(m), c ? (c.scope ? (s = a.$new(), l.data("$scope", s)) : s = a, (l = c.transclude) || !e && b ? c(g, s, m, d, V(a, l || b)) : c(g, s, m, d, e)) : g && g(a, m.childNodes, r, e)
                    }

                    for (var k = [], m, l, s, n, p = 0; p < a.length; p++) m = new Eb, l = J(a[p], [], m, 0 ===
                    p ? d : r, e), (g = l.length ? ia(l, a[p], m, b, c, null, [], [], g) : null) && g.scope && ha(A(a[p]), "ng-scope"), m = g && g.terminal || !(s = a[p].childNodes) || !s.length ? null : N(s, g ? g.transclude : b), k.push(g, m), n = n || g || m, g = null;
                    return n ? f : null
                }
                        ...
                        case 1:
                            ...
                            C; p++) {
                                ...
                                if (!M || 8 <= M || l.specified) {
                                    s = l.name;
                                    n = ma(s);
                                    W.test(n) && (s = cb(n.substr(6), "-"));
                                    var v = n.replace(/(Start|End)$/, "");
                                    n === v + "Start" && (y = s, R = s.substr(0, s.length - 5) + "end", s = s.substr(0, s.length - 6));
                                    n = ma(s.toLowerCase());
                                    k[n] = s;
                                    c[n] = l = aa(l.value);
                                    ec(a, n) && (c[n] = !0);
                ...
                function ia(a, c, d, e, g, f, m, n, p) {
                    ...
                    function E(a, e, g, f, p) {
                        ...
                        var I, v, N, u, P, J, ba = {}, gb;
                        I = c === g ? d : Sb(d, new Eb(A(g), d.$attr));
                        v = I.$$element;
                        if (H) {
                            var T = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
                            f = A(g);
                        ...
                        for (N = m.length; f < N; f++) try {
                            u = m[f], u(u.isolateScope ? J : e, v, I, u.require && R(u.require, v, ba), gb)
                        } catch (G) {
                            l(G, ga(v))
                        }
                        f = e;
                        ...
                        for (f = n.length - 1; 0 <= f; f--) try {
                            u = n[f], u(u.isolateScope ? J : e, v, I, u.require && R(u.require, v, ba), gb)
                        } catch (B) {
                            l(B, ga(v))
                        }
                    }
                    ...
                    for (var T = !1, z = !1, t = d.$$element = A(c), G, ca, U, F = e, O, M = 0, na = a.length; M < na; M++) {
                        ...
                        if (U = G.transclude) T = !0, G.$$tlb || (x("transclusion", p, G, t), p = G), "element" == U ? (z = !0, N = G.priority, U = ba(c, Ua, S),
                            t = d.$$element = A(Q.createComment(" " + ca + ": " + d[ca] + " ")), c = t[0], hb(g, A(va.call(U, 0)), c), F = v(U, e, N, f && f.name, {nonTlbTranscludeDirective: p})) : (U = A(zb(c)).contents(), t.empty(), F = v(U, e));
                        ...
                        if (G.templateUrl) x("template", ia, G, t), ia = G, G.replace && (f = G), E = w(a.splice(M, a.length - M), t, d, g, F, m, n, {
                            ...
                            O = G.compile(t, d, F), L(O) ? y(null, O, Ua, S) : O && y(O.pre, O.post, Ua, S)
                        } catch (Z) {
                            l(Z, ga(t))
                        }
                ...
                function T(b, e, g, f, k, s, n) {
                    ...
                    if (c.hasOwnProperty(e)) {
                        ...
                        for (var C = 0, y = e.length; C < y; C++) try {
                            p = e[C], (f === r || f > p.priority) && -1 != p.restrict.indexOf(g) && (s && (p = Rb(p, {
                                $$start: s,
                                $$end: n
                            })), b.push(p), k = p)
                        } catch (v) {
                ...
                function w(a, b, c, d, e, g, f, m) {
                    ...
                    n.get(u.getTrustedResourceUrl(R), {cache: p}).success(function (n) {
                        ...
                        a.unshift(v);
                        l = ia(a, p, c, e, b, y, g, f, m);
                        q(d, function (a, c) {
                            a == p && (d[c] = b[0])
                        });
                        for (s = N(b[0].childNodes, e); k.length;) {
                            n = k.shift();
                            E = k.shift();
                            var H = k.shift(), ha = k.shift(), u = b[0];
                            E !== C && (u = zb(p), hb(H, A(E), u));
                            E = l.transclude ? V(n, l.transclude) : ha;
                            l(s, n, u, d, E)
                        }
                        k = null
                    ...
                    return function (a, b, c, d, e) {
                        k ? (k.push(b),
                            k.push(c), k.push(d), k.push(e)) : l(s, b, c, d, e)
                    }
                }
                ...
                function S(a, c, d, e) {
                    var g = b(d, !0);
                    if (g) {
                        if ("multiple" === e && "SELECT" === Fa(a)) throw ja("selmulti", ga(a));
                        c.push({
                ...
                var ca = b.startSymbol(), na = b.endSymbol(), Y = "{{" == ca || "}}" == na ? Aa : function (a) {
    ...
    function id() {
        ...
        this.$get = ["$injector", "$window", function (c, d) {
            return function (e, g) {
                var f, h, m;
                D(e) && (f = e.match(a), h = f[1], m = f[3], e = b.hasOwnProperty(h) ? b[h] : ub(g.$scope, h, !0) || ub(d, h, !0), Oa(e, h, !0));
                f = c.instantiate(e, g);
                if (m) {
    ...
    function ld() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, n, p) {
            function s(a) {
                function c(a) {
                    var b = t({}, a, {data: nc(a.data, a.headers, d.transformResponse)});
            ...
            function C(b,
                       c, g) {
                function f(a, b, c) {
                    u && (200 <= a && 300 > a ? u.put(r, [a, b, lc(c)]) : u.remove(r));
                    m(b, a, c);
                    d.$$phase || d.$apply()
                }
    ...
    function od(b, a, c, d, e) {
        ...
        return function (e, m, k, l, n, p, s, C) {
            ...
            if ("jsonp" == x(e)) {
                ...
                v.open(e, m, !0);
                q(n, function (a, b) {
                    B(a) && v.setRequestHeader(b,
                        a)
                });
                v.onreadystatechange = function () {
                    if (v && 4 == v.readyState) {
                        var a = null, b = null;
                        u !== f && (a = v.getAllResponseHeaders(), b = v.responseType ? v.response : v.responseText);
                        E(l, u || v.status, b, a)
                    }
                };
    ...
    function pd() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function (c, d, e) {
            function g(g,
                ...
                if (l && 1 < C.length) throw oc("noconcat", g);
                if (!k || E) return u.length = y, s = function (a) {
                    try {
                        for (var b = 0, c = y, f; b < c; b++) "function" == typeof (f = C[b]) && (f = f(a), f = l ? e.getTrusted(l, f) : e.valueOf(f), null === f || z(f) ? f = "" : "string" != typeof f && (f = pa(f))), u[b] = f;
                        return u.join("")
                    } catch (h) {
                        a =
                            oc("interr", g, h.toString()), d(a)
                    }
                }, s.exp = g, s.parts = C, s
            }
    ...
    function qc(b, a, c) {
        ...
        a.$$host = b.hostname;
        a.$$port = S(b.port) || sd[b.protocol] || null
    }
    ...
    function sc(b, a) {
        ...
        this.$$compose = function () {
            var a = Xb(this.$$search), b = this.$$hash ? "#" +
                sb(this.$$hash) : "";
    ...
    function Ib(b, a) {
        ...
        this.$$compose = function () {
            var c = Xb(this.$$search), e = this.$$hash ? "#" + sb(this.$$hash) : "";
    ...
    function td() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, g) {
            ...
            a ? (m = k.substring(0, k.indexOf("/", k.indexOf("//") + 2)) + (m || "/"), e = e.history ? sc : tc) : (m = Va(k),
                e = Ib);
            h = new e(m, "#" + b);
            h.$$parse(h.$$rewrite(k));
    ...
    function wc(b, a, c) {
        ...
        if (a.unwrapPromises || 1 !== e) if (a.unwrapPromises || 2 !== e) if (a.csp) g = 6 > e ? vc(d[0], d[1], d[2], d[3], d[4], c, a) : function (b, g) {
            var f = 0, h;
            do h = vc(d[f++],
                d[f++], d[f++], d[f++], d[f++], c, a)(b, g), g = r, b = h; while (f < e);
            return h
        }; else {
            var f = "var p;\n";
            q(d, function (b, d) {
    ...
    function xd() {
        ...
        this.$get = ["$filter", "$sniffer", "$log", function (c, d, e) {
            a.csp = d.csp;
            ra = function (b) {
                a.logPromiseWarnings && !xc.hasOwnProperty(b) && (xc[b] =
                    !0, e.warn("[$parse] Promise found in the expression `" + b + "`. Automatic unwrapping of promises in Angular expressions is deprecated."))
            };
            return function (d) {
                var e;
                switch (typeof d) {
    ...
    function Ad() {
        ...
        this.$get = ["$injector", "$exceptionHandler",
            "$parse", "$browser", function (d, e, g, f) {
                function h() {
                    this.$id = Ya();
                ...
                h.prototype = {
                    constructor: h, $new: function (a) {
                        ...
                        var d, f, g, h, k = this.$$asyncQueue, l = this.$$postDigestQueue, q, v, r = b, N, V = [], J, A,
                            P;
                        m("$digest");
                        c = null;
                        do {
                            ...
                            a:do {
                                if (h = N.$$watchers) for (q = h.length; q--;) try {
                                    if (d = h[q]) if ((f = d.get(N)) !== (g = d.last) && !(d.eq ? ua(f, g) : "number" == typeof f && "number" == typeof g && isNaN(f) && isNaN(g))) v = !0, c = d, d.last = d.eq ? fa(f) : f, d.fn(f, g === n ? f : g, N), 5 > r && (J = 4 - r, V[J] || (V[J] = []), A = L(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, A += "; newVal: " + pa(f) + "; oldVal: " + pa(g), V[J].push(A)); else if (d === c) {
                                        v = !1;
                                        break a
                                    }
                                } catch (t) {
                            ...
                            if (v && !r--) throw p.$$phase = null, a("infdig", b, pa(V));
                        } while (v || k.length);
                        ...
                        if (!this.$$destroyed) {
                            ...
                            this.$$destroyed = !0;
                            this !== p && (q(this.$$listenerCount, bb(null, l, this)), a.$$childHead == this && (a.$$childHead = this.$$nextSibling), a.$$childTail == this && (a.$$childTail =
    ...
    function Bd() {
        ...
        this.$get = function () {
            return function (c, d) {
                var e = d ? a : b, g;
                if (!M || 8 <=
                    M) if (g = qa(c).href, "" !== g && !g.match(e)) return "unsafe:" + g;
                return c
            }
        }
    }
    ...
    function Fc(b, a, c, d, e) {
        ...
        if (k) 0 < e && (-1 < b && 1 > b) && (h = b.toFixed(e)); else {
            ...
            if (f.length >= n + p) for (l = f.length - n, k = 0; k < l; k++) 0 === (l - k) % p && 0 !==
            k && (h += c), h += f.charAt(k);
    ...
    function Cc(b) {
        ...
        return function (c, e) {
            ...
            D(c) && (c = Nd.test(c) ? S(c) : a(c));
            rb(c) && (c = new Date(c));
            if (!Ja(c)) return c;
            for (; e;) (m = Od.exec(e)) ? (f = f.concat(va.call(m, 1)), e = f.pop()) : (f.push(e), e = null);
            q(f, function (a) {
                h = Pd[a];
    ...
    function Hc(b, a) {
        ...
        d.$setDirty = function () {
            b.removeClass(Ha).addClass(ob);
            d.$dirty = !0;
            d.$pristine = !1;
            e.$setDirty()
        };
        d.$setPristine = function () {
            b.removeClass(ob).addClass(Ha);
            d.$dirty = !1;
            d.$pristine = !0;
            q(h, function (a) {
                a.$setPristine()
    ...
    function pb(b, a, c, d, e, g) {
        ...
        var h = function () {
            if (!f) {
                ...
                d.$viewValue !==
                e && (b.$$phase ? d.$setViewValue(e) : b.$apply(function () {
                    d.$setViewValue(e)
                }))
            }
        };
        ...
        l && ((e = l.match(/^\/(.*)\/([gim]*)$/)) ? (l = RegExp(e[1], e[2]), e = function (a) {
            ...
            var d = b.$eval(l);
            if (!d || !d.test) throw F("ngPattern")("noregexp", l, d, ga(a));
            return n(d, c)
        ...
        if (c.ngMaxlength) {
            ...
            e = function (a) {
                if (!d.$isEmpty(a) &&
                    a.length > s) return d.$setValidity("maxlength", !1), r;
    ...
    var x = function (b) {
        ...
        }, M, A, Ba, va = [].slice, Qd = [].push, Za = Object.prototype.toString, La = F("ng"),
        Na = Z.angular || (Z.angular = {}), Ta, Fa, ka = ["0", "0", "0"];
    M = S((/msie (\d+)/.exec(x(navigator.userAgent)) || [])[1]);
    isNaN(M) && (M = S((/trident\/.*; rv:(\d+)/.exec(x(navigator.userAgent)) ||
        [])[1]));
    w.$inject = [];
    Aa.$inject = [];
    var aa = function () {
    ...
    var Tc = /[A-Z]/g, Rd = {full: "1.2.7", major: 1, minor: 2, dot: 7, codeName: "emoji-clairvoyance"},
        Qa = O.cache = {}, db = O.expando = "ng-" + (new Date).getTime(),
        Xc = 1, Ic = Z.document.addEventListener ? function (b, a, c) {
            b.addEventListener(a, c, !1)
        } : function (b, a, c) {
            b.attachEvent("on" + a, c)
        }, Ab = Z.document.removeEventListener ? function (b, a, c) {
            b.removeEventListener(a, c, !1)
        } : function (b, a, c) {
            b.detachEvent("on" + a, c)
        }, Vc = /([\:\-\_]+(.))/g, Wc = /^moz([A-Z])/, xb = F("jqLite"), Ea = O.prototype = {
            ready: function (b) {
                function a() {
                    c || (c = !0, b())
                }
    ...
    q({
        data: bc, inheritedData: eb, scope: function (b) {
            ...
            var d = x(a);
            if (fb[d]) if (B(c)) c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || w).specified ?
                d : r; else if (B(c)) b.setAttribute(a, c); else if (b.getAttribute) return b = b.getAttribute(a, 2), null === b ? r : b
        }, prop: function (b, a, c) {
            ...
            for (var c = 0, d = b.childNodes; c < d.length; c++) Ca(d[c]);
            b.innerHTML = a
        }, empty: dc
    }, function (b, a) {
        O.prototype[a] = function (a, d) {
            var e, g;
            if (b !== dc && (2 == b.length && b !== Bb && b !== cc ? a : d) === r) {
                if (X(a)) {
    ...
    q({
        removeData: $b,
        dealoc: Ca, on: function a(c, d, e, g) {
            if (B(g)) throw xb("onargs");
            var f = la(c, "events"), h = la(c, "handle");
            f || la(c, "events", f = {});
            h || la(c, "handle", h = Yc(c, f));
        ...
        O.prototype[c] = function (c, e, g) {
            for (var f, h = 0; h < this.length; h++) z(f) ? (f = a(this[h], c, e, g), B(f) && (f = A(f))) : yb(f, a(this[h], c, e, g));
            return B(f) ? f : this
        };
    ...
    var $c = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, ad = /,/, bd = /^\s*(_?)(\S+?)\1\s*$/, Zc =
        /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Sa = F("$injector"), Sd = F("$animate"), Td = ["$provide", function (a) {
        this.$$selectors = {};
    ...
    var hd = /^(x[\:\-_]|data[\:\-_])/i, oc = F("$interpolate"), Ud = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/,
        sd = {http: 80, https: 443, ftp: 21}, Hb = F("$location");
    tc.prototype = Ib.prototype = sc.prototype = {
        $$html5: !1, $$replace: !1, absUrl: ib("$$absUrl"), url: function (a, c) {
            ...
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (D(a)) this.$$search = Wb(a); else if (X(a)) this.$$search =
                        a; else throw Hb("isrcharg");
                    break;
                default:
        ...
        constructor: Kb, lex: function (a) {
            ...
            for (a = []; this.index < this.text.length;) {
                ...
                if (this.is("\"'")) this.readString(this.ch); else if (this.isNumber(this.ch) || this.is(".") && this.isNumber(this.peek())) this.readNumber(); else if (this.isIdent(this.ch)) this.readIdent(), this.was("{,") && ("{" === a[0] && (c = this.tokens[this.tokens.length - 1])) && (c.json = -1 === c.text.indexOf(".")); else if (this.is("(){}[].,;:?")) this.tokens.push({
                    ...
                    var d = this.ch + this.peek(), e = d + this.peek(2), g = Ia[this.ch], f = Ia[d], h = Ia[e];
                    h ? (this.tokens.push({
                        index: this.index,
                        text: e,
                        fn: h
            ...
            d = d || this.index;
            c = B(c) ? "s " + c + "-" + this.index + " [" + this.text.substring(c, d) +
                "]" : " " + d;
    ...
    Xa.prototype = {
        constructor: Xa, parse: function (a, c) {
            this.text = a;
            this.json = c;
        ...
        peek: function (a, c, d, e) {
            ...
            return t(function (e, g) {
                ...
                if (!f) return r;
                (f = Wa(f[h], c.text)) && (f.then && c.options.unwrapPromises) && (m = f, "$$v" in f || (m.$$v = r, m.then(function (a) {
                    m.$$v = a
                })), f = f.$$v);
                return f
            }, {
    ...
    var Jb = {}, sa = F("$sce"), ea = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"},
        Y = Q.createElement("a"), zc = qa(Z.location.href, !0);
    Ac.$inject = ["$provide"];
    Bc.$inject = ["$locale"];
    Dc.$inject = ["$locale"];
    var Gc = ".", Pd = {
        ...
        Z: function (a) {
            ...
            return a = (0 <= a ? "+" : "") + (Lb(Math[0 < a ? "floor" : "ceil"](a / 60), 2) +
                Lb(Math.abs(a % 60), 2))
        }
    ...
    var Jc = function (a) {
        ...
        $d = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/, ae =
            /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Kc = {
            text: pb, number: function (a, c, d, e, g, f) {
                ...
                e.$formatters.push(function (a) {
                    if (e.$isEmpty(a) || rb(a)) return e.$setValidity("number", !0), a;
                    e.$setValidity("number", !1);
                    return r
                })
                ...
                pb(a, c, d, e, g, f);
                a = function (a) {
                    if (e.$isEmpty(a) || Zd.test(a)) return e.$setValidity("url", !0), a;
                    e.$setValidity("url", !1);
                    return r
                };
                e.$formatters.push(a);
            ...
            email: function (a, c, d, e, g, f) {
                pb(a, c, d, e, g, f);
                a = function (a) {
                    if (e.$isEmpty(a) || $d.test(a)) return e.$setValidity("email", !0), a;
        ...
        }], mb = "ng-valid", lb = "ng-invalid", Ha = "ng-pristine",
        ob = "ng-dirty", be = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", function (a, c, d, e, g) {
            function f(a, c) {
                c = c ? "-" + cb(c, "-") : "";
            ...
            this.$setPristine = function () {
                this.$dirty = !1;
                this.$pristine = !0;
                e.removeClass(ob).addClass(Ha)
            };
            this.$setViewValue = function (d) {
                this.$viewValue = d;
                this.$pristine && (this.$dirty = !0, this.$pristine = !1, e.removeClass(Ha).addClass(ob),
                    k.$setDirty());
        ...
        }], ke = Mb("", !0), le = Mb("Odd", 0), me = Mb("Even", 1), ne = ta({
    ...
    var pe = ["$animate", function (a) {
        return {
            ...
            link: function (c, d, e, g, f) {
                ...
                c.$watch(e.ngIf, function (g) {
                    Ma(g) ? m || (m = c.$new(), f(m, function (c) {
                        c[c.length++] = Q.createComment(" end ngIf: " + e.ngIf + " ");
                        h = {clone: c};
                        a.enter(c, d.parent(), d)
                    })) : (m && (m.$destroy(), m = null), h && (a.leave(vb(h.clone)), h = null))
                })
            }
        }
    ...
    }), te = ta({terminal: !0, priority: 1E3}), ue = ["$locale", "$interpolate", function (a, c) {
        var d = /{}/g;
        return {
            restrict: "EA", link: function (e,
                                            g, f) {
        ...
        return {
            transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, g, f, h, m) {
                var k = f.ngRepeat, l = k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/),
                    n, p, s, r, y, t, u = {$id: Da};
                if (!l) throw d("iexp", k);
                f = l[1];
                h = l[2];
                ...
                e.$watchCollection(h,
                    function (a) {
                        ...
                        for (D in B) B.hasOwnProperty(D) && (w = B[D], f = vb(w.clone), c.leave(f), q(f, function (a) {
                            a.$$NG_REMOVED =
                                !0
                        }), w.scope.$destroy());
                        f = 0;
                        for (h = T.length; f < h; f++) {
                            ...
                            if (w.scope) {
                                ...
                                w.clone[0] != n && c.move(vb(w.clone), null, A(l));
        ...
        return {
            restrict: "EA", require: "ngSwitch", controller: ["$scope",
                function () {
                    this.cases = {}
        ...
        transclude: "element", priority: 800, require: "^ngSwitch", compile: function (a, c) {
            return function (a, e, g, f, h) {
                f.cases["!" + c.ngSwitchWhen] = f.cases["!" +
                c.ngSwitchWhen] || [];
    ...
    }], Ee = F("ngOptions"), Fe = $({terminal: !0}), Ge = ["$compile", "$parse", function (a, c) {
            ...
            link: function (e, f, h, m) {
                ...
                function n(e, f, g) {
                    function h() {
                        ...
                        t = g.$modelValue;
                        v = A(e) || [];
                        var C = n ? Ob(v) : v, F, I, z;
                        I = {};
                        r = !1;
                        var E, H;
                        if (s) if (w && K(t)) for (r = new Ra([]), z = 0; z < t.length; z++) I[l] = t[z], r.put(w(e, I), t[z]); else r = new Ra(t);
                        for (z = 0; F = C.length, z < F; z++) {
                            ...
                            s ? d = B(r.remove(w ? w(e, I) : q(e, I))) : (w ? (d = {}, d[l] = t, d =
                                w(e, d) === w(e, I)) : d = t === q(e, I), r = r || d);
                            E = m(e, I);
                            E = B(E) ? E : "";
                        ...
                        for (C = c.length; I < C; I++) {
                            ...
                            E = null;
                            z = 0;
                            for (F = k.length; z < F; z++) r = k[z], (d = v[z + 1]) ? (E = d.element, d.label !== r.label &&
                            E.text(d.label = r.label), d.id !== r.id && E.val(d.id = r.id), E[0].selected !== r.selected && E.prop("selected", d.selected = r.selected)) : ("" === r.id && y ? H = y : (H = u.clone()).val(r.id).attr("selected", r.selected).text(r.label), v.push({
                                element: H,
                                label: r.label,
                                id: r.id,
                                selected: r.selected
                    ...
                    var k;
                    if (!(k = t.match(d))) throw Ee("iexp", t, ga(f));
                    var m = c(k[2] || k[1]), l = k[4] || k[6], n = k[5], p = c(k[3] || ""),
                        q = c(k[2] ? k[1] : l), A = c(k[7]), w = k[8] ? c(k[8]) : null, x = [[{element: f, label: ""}]];
                    y && (a(y)(e), y.removeClass("ng-scope"), y.remove());
                    f.empty();
                    f.on("change", function () {
                        e.$apply(function () {
                            var a, c = A(e) || [], d = {}, h, k, m, p, t, u, v;
                            if (s) for (k = [], p = 0, u = x.length; p < u; p++) for (a = x[p], m = 1, t = a.length; m < t; m++) {
                                if ((h = a[m].element)[0].selected) {
                                    h = h.val();
                                    n && (d[n] = h);
                                    if (w) for (v = 0; v < c.length && (d[l] = c[v], w(e, d) != h); v++) ; else d[l] = c[h];
                                    k.push(q(e, d))
                                }
    ...
    }], Ie = $({restrict: "E", terminal: !0});
    (Ba = Z.jQuery) ? (A = Ba, t(Ba.fn, {
        scope: Ea.scope,
        isolateScope: Ea.isolateScope, controller: Ea.controller, injector: Ea.injector, inheritedData: Ea.inheritedData
    }), wb("remove", !0, !0, !1), wb("empty", !1, !1, !1), wb("html", !1, !1, !0)) : A = O;
    Na.element = A;
    (function (a) {
        t(a, {
            bootstrap: Yb,
        ...
        try {
            ...
            Ta("ngLocale", []).provider("$locale", rd)
        }
        Ta("ng", ["ngLocale"], ["$provide", function (a) {
            ...
            a.provider("$compile", ic).directive({
                ...
                ngRequired: Mc,
                ngValue: ge
            }).directive({ngInclude: re}).directive(Nb).directive(Nc);
            a.provider({
                $anchorScroll: cd,
                $animate: Td,
                $browser: ed,
